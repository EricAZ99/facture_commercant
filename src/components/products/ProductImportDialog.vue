...
import { parseProductsCsv } from '@/utils/productCsv'
...
function onFileChange(event: Event): void {
  ...
  reader.onload = () => {
    ...
    previewCount.value = products.length
...
<template>
  <BaseModal :open="open" title="Importer des produits (CSV)" @close="onClose">
    <div class="flex flex-col gap-4">
      <p class="text-sm text-gray-500">
        Colonnes attendues : Nom, Categorie, Type ("product" ou "service"), Prix, TVA, SKU, Stock,
        Code-barres. Une ligne d'entete est optionnelle.
      </p>
